...
export const monteriaSedeANodes: Tour360Node[] = [
  ...
  createMonteriaNode({
    id: '2',
    caption: 'Entrada de Sede A Monteria',
    description: 'Entrada de la sede A del recorrido 360 de la Sede Monteria.',
    gpsIndex: 2,
    links: [
      createTourLink({
        from: '2',
  ...
  createMonteriaNode({
    id: '3',
    caption: 'Lobby monteria',
    description: 'Lobby de la sede del recorrido 360 de la Sede Monteria.',
    gpsIndex: 3,
    links: [
      createTourLink({
        from: '3',
