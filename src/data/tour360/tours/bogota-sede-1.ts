...
const GuiaEntradaSA = resolveLegacyPanoramaUrl('alizon.png');
...
export const bogotaSede1AvailablePanoramaFiles = [
  ...
  { id: 'Entrada_A', panorama: Entrada_A, name: 'Entrada_A', fileName: '3SA.png' },
  ...
  { id: 'SphereTest', panorama: SphereTestImage, name: 'Modo test', fileName: 'sphere-test.jpg' },
];
